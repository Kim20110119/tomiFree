                                    ...
                                    <div class="inner">
                                        <div id="text1" class="txt-decbox2">
                                            ...
                                            <div class="body">
                                                ...
                                                <br clear="all">
                                                <p class="txt-img"><img src="{{url('img/affiliate/common','cegao.gif')}}" align="left" /></p>
                                                <div class="bln balloon7">
                                                    <p class="img-l">&nbsp;</p>
                                                    <div class="b_body rnd1">
                                        ...
                                        <div id="text2" class="txt-decbox2">
                                            ...
                                            <div class="body">
                                                ...
                                                <h5>　はじめての方は上から順にどうぞ♪<img src="{{url('img/affiliate/common','yajirushi2_d.jpg')}}" alt="アフィリエイトの始め方" /></h5>
                                                <table class="rnk1item" cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            <th>
                                                                <!-- startRank -->
                                                                <p><img src="{{url('img/affiliate/common','y1.jpg')}}" alt="アフィリエイトの始め方" /></p>
                                                                <!-- /endRank -->
                                                            </th>
                                                            <td class="timg"><a href="./category1/"><img alt="アフィリエイトの始め方　０日目" src="{{url('img/affiliate/common','0n.jpg')}}" /></a></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="timg"><a href="./category2/"><img alt="アフィリエイトの始め方　１日目" src="{{url('img/affiliate/common','0n.jpg')}}" /></a></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <th>
                                                                <!-- startRank -->
                                                                <p><img src="{{url('img/affiliate/common','y2.gif')}}" alt="アフィリエイトの始め方" /></p>
                                                                <!-- /endRank -->
                                                            </th>
                                                            <td class="timg"><a href="./category3/"><img alt="" src="{{url('img/affiliate/common','2n.jpg')}}" /></a></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="timg"><a href="./category5/"><img src="{{url('img/affiliate/common','3n.jpg')}}" alt="アフィリエイトの始め方　３日目" /></a></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="timg"><a href="./category6/"><img src="{{url('img/affiliate/common','4n.jpg')}}" alt="アフィリエイトの始め方　４日目" /></a></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="timg"><a href="./category7/"><img src="{{url('img/affiliate/common','5n.jpg')}}" alt="アフィリエイトの始め方　５日目" /></a></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="timg"><a href="./category8/"><img src="{{url('img/affiliate/common','6n.jpg')}}" alt="アフィリエイトの始め方　６日目" /></a></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="timg"><a href="./category4/"><img src="{{url('img/affiliate/common','7n.jpg')}}" alt="コラム" /></a></td>
                                                            <td>
